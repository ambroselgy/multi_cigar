...
#{"$and": [{"cigar_name": {"$regex":"Cohiba",'$options':'i'}}, {"stock": {"$regex": "available",'$options':'i'}}]}
...
{$and:[{"cigar_name": {"$regex":"Cohiba",'$options':'i'}}, {$or:[{"cigar_name":{"$regex":"bolivar",'$options':'i'}},{"cigar_name":{"$regex":"Bolívar",'$options':'i'}}]}]}