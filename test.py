...
tmp_items = 'https://www.cigarworld.de/en/zigarren/cuba/la-casa-del-habano/cohiba-lcdh-novedosos-lcdhhabanos-specialist-exklusiv-90015227_38751'
...
for i in tmp_list:
    tmp_brand = i.find('div',class_='ws-u-1 VariantInfo-itemName')
